## Prisma + PostgreSQL Integration (SparkPilot‑X)
...
```
MAIN_VITE_POSTGRES_URL=postgres://postgres:postgres@localhost:5432/sparkpilot-x
```
...
- Prisma client singleton: `src/main/shared/prisma.ts`
...
1) Start Postgres 17 locally and ensure the DB exists (`sparkpilot-x`).
